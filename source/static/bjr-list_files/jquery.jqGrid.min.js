						...
						if (this.tagName != "TABLE")
							...
							if (this.p.colNames.length !== this.p.colModel.length)
								...
								var r = b("<div class='ui-jqgrid-view'></div>"), u, B = b.browser.msie ? true
										...
										: false;
								a = this;
								if(this.p.shrinkToFit==true){
									$(window).resize(function(){
										//$('#list').setGridWidth($(window).width()*0.99);
										$('#list').setGridWidth(document.body.clientWidth);
									});
								}
								...
								b(
										...
										u).insertBefore(r);
								b(
										"<div style='width:100px;height:30px' class='loading ui-state-default ui-state-active' id='load_"
												+ this.id + "'><span class=\"red\"><font size='3'>"
												+ this.p.loadtext + "</font></span></div>")
										.insertBefore(r);
								b(this)
										.attr(
												{
								...
								for (k = 0; k < this.p.colNames.length; k++) {
									ma = a.p.headertitles ? ' title="'
											...
											+ '"' : "";
									var tdCss = "ui-state-default";
									if(this.p.cssType!=''){
										tdCss = "ui-state-default-2";
									}
									aa += "<th id='"
											+ a.p.id
											+ "_"
											+ a.p.colModel[k].name
											+ "' role='columnheader' class='"+tdCss+" ui-th-column ui-th-"
											+ l + "'" + ma + ">";
